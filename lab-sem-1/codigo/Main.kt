...
fun main(args: Array<String>): Unit {
    ...
    for (i in 0 until intentos) {
        ...
        if(!estaEnOrdenAscendente(secuenciaCopia)){
            ...
            mensajeErrorEnElOrdenamiento("Bubble Sort")
            return
        }
    ...
    mensajeOrdenamientoExitoso("Bubble Sort", tiempoBubbleSort)
    ...
    for (i in 0 until intentos) {
        ...
        if(!estaEnOrdenAscendente(secuenciaCopia)){
            // Si la secuencia copia no está ordenada, imprime un mensaje de error y termina la ejecución
            mensajeErrorEnElOrdenamiento("Insertion Sort")
            return
        }
        // Se guarda el tiempo de ejecución
    ...
    // Si la secuencia está ordenada en todos los intentos, imprime un mensaje de éxito
    mensajeOrdenamientoExitoso("Insertion Sort", tiempoInsertionSort)
    ...
    for (i in 0 until intentos) {
        ...
        if(!estaEnOrdenAscendente(secuenciaCopia)){
            // Si la secuencia copia no está ordenada, imprime un mensaje de error y termina la ejecución
            mensajeErrorEnElOrdenamiento("Selection Sort")
            return
        }
        // Se guarda el tiempo de ejecución
    ...
    // Si la secuencia está ordenada en todos los intentos, imprime un mensaje de éxito
    mensajeOrdenamientoExitoso("Selection Sort", tiempoSelectionSort)

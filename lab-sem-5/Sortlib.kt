...
* Descrición: counting crea particiones en el arreglo A y las ordena recursivamente
*/
...
* uso: getMax(A)
* Precondición: A es un arreglo de enteros
* Postcondición: devuelve el valor máximo en el arreglo A como un entero
*/
...
* Descrición: countingSort crea particiones en el arreglo A y las ordena iterativamente
* Complejidad: O(n+k)
*/

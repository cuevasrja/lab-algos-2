...
fun main() {
    ...
    println("Añadimos el elemento 100 al principio de la lista.")
    lista.agregarAlFrente(100)
    println("Lista modificada: \u001b[33m$lista\u001b[0m")
    println("Añadimos el elemento 200 al final de la lista.")
    ...
    println("Imprimimos el tope de la pila: ${pila.tope()}")
    ...
    println("Imprimimos el primero de la cola: ${cola.primero()}")
